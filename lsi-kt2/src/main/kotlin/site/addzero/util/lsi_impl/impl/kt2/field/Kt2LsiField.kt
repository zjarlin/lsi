...
package site.addzero.util.lsi_impl.impl.kt2.field
...
class Kt2LsiField(
    ...
    override val fieldTypeClass: LsiClass? by lazy {
        ...
        analyze(ktProperty) {
            ...
            (classSymbol.psi as? KtClass)?.let { Kt2LsiClass(it, classSymbol, this@analyze) }
        }
    }
    ...
    private fun extractColumnName(): String? {
        ...
        // 兜底策略：将字段名转换为下划线命名格式
        return name?.toSnakeCaseLowerCase()
    }
}
