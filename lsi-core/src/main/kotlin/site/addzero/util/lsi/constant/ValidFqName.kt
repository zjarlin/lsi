...
import site.addzero.util.lsi.types.PojoAnnotationCategory
...
@Deprecated(
    ...
    ReplaceWith("PojoAnnotationType.JIMMER_ENTITY.fqName", "site.addzero.util.lsi.types.PojoAnnotationType")
)
...
@Deprecated(
    ...
    ReplaceWith("PojoAnnotationType.entries.filter { it.category == PojoAnnotationCategory.ENTITY && it.fqName.contains(\"jimmer\") }.map { it.fqName }.toSet()", "site.addzero.util.lsi.types.PojoAnnotationType", "site.addzero.util.lsi.types.PojoAnnotationCategory")
)
...
@Deprecated(
    ...
    ReplaceWith("PojoAnnotationType.allFqNames", "site.addzero.util.lsi.types.PojoAnnotationType")
)
...
@Deprecated(
    ...
    ReplaceWith("PojoAnnotationType.allEntityAnnotations.map { it.fqName }.toSet()", "site.addzero.util.lsi.types.PojoAnnotationType")
)
...
@Deprecated(
    ...
    ReplaceWith("(PojoAnnotationType.allEntityAnnotations + PojoAnnotationType.allTableAnnotations).map { it.shortName }.toSet().toList()", "site.addzero.util.lsi.types.PojoAnnotationType")
)
...
@Deprecated(
    ...
    ReplaceWith("PojoAnnotationType.allTableAnnotations.map { it.fqName }.toSet()", "site.addzero.util.lsi.types.PojoAnnotationType")
)
...
@Deprecated(
    ...
    ReplaceWith("PojoAnnotationType.allLombokAnnotations.map { it.fqName }.toSet()", "site.addzero.util.lsi.types.PojoAnnotationType")
)
...
@Deprecated(
    ...
    ReplaceWith("DocumentationAnnotationType.EXCEL_PROPERTY_ALIBABA.fqName", "site.addzero.util.lsi.types.DocumentationAnnotationType")
)
...
@Deprecated(
    ...
    ReplaceWith("DocumentationAnnotationType.EXCEL_PROPERTY_IDEV.fqName", "site.addzero.util.lsi.types.DocumentationAnnotationType")
)
...
@Deprecated(
    ...
    ReplaceWith("DocumentationAnnotationType.EXCEL_EASYPOI.fqName", "site.addzero.util.lsi.types.DocumentationAnnotationType")
)
...
@Deprecated(
    ...
    ReplaceWith("DocumentationAnnotationType.SWAGGER_V2_API_MODEL_PROPERTY.fqName", "site.addzero.util.lsi.types.DocumentationAnnotationType")
)
...
@Deprecated(
    ...
    ReplaceWith("DocumentationAnnotationType.SWAGGER_V3_SCHEMA.fqName", "site.addzero.util.lsi.types.DocumentationAnnotationType")
)
...
@Deprecated(
    ...
    ReplaceWith("ColumnAnnotationType.MYBATIS_PLUS_TABLE_FIELD.fqName", "site.addzero.util.lsi.types.ColumnAnnotationType")
)
...
@Deprecated(
    ...
    ReplaceWith("PojoAnnotationType.JPA_ENTITY.fqName", "site.addzero.util.lsi.types.PojoAnnotationType")
)
const val ENTITY = "javax.persistence.Entity"

@Deprecated(
    "Use PojoAnnotationType.JPA_MAPPED_SUPERCLASS.fqName instead",
    ReplaceWith("PojoAnnotationType.JPA_MAPPED_SUPERCLASS.fqName", "site.addzero.util.lsi.types.PojoAnnotationType")
)
const val MAPPED_SUPERCLASS = "javax.persistence.MappedSuperclass"

@Deprecated(
    "Use ColumnAnnotationType.JIMMER_COLUMN.fqName instead",
    ReplaceWith("ColumnAnnotationType.JIMMER_COLUMN.fqName", "site.addzero.util.lsi.types.ColumnAnnotationType")
)
...
@Deprecated(
    ...
    ReplaceWith("CollectionType.isCollection(typeName)", "site.addzero.util.lsi.types.CollectionType")
)
...
@Deprecated(
    ...
    ReplaceWith("DocumentationAnnotationType.fqNameToAttributeMap", "site.addzero.util.lsi.types.DocumentationAnnotationType")
)
...
@Deprecated(
    ...
    ReplaceWith("ColumnAnnotationType.fqNameToAttributeMap", "site.addzero.util.lsi.types.ColumnAnnotationType")
)
...
@Deprecated(
    ...
    ReplaceWith("ColumnAnnotationType.allFqNames", "site.addzero.util.lsi.types.ColumnAnnotationType")
)
val COLUMN_ANNOTATIONS get() = ColumnAnnotationType.allFqNames

@Deprecated(
    "Use NullabilityAnnotationType.allNullableSimpleNames instead",
    ReplaceWith("NullabilityAnnotationType.allNullableSimpleNames", "site.addzero.util.lsi.types.NullabilityAnnotationType")
)
...
@Deprecated(
    ...
    ReplaceWith("NullabilityAnnotationType.allNonNullSimpleNames", "site.addzero.util.lsi.types.NullabilityAnnotationType")
)
...
@Deprecated(
    ...
    ReplaceWith("NullabilityAnnotationType.NULL_MARKED.simpleName", "site.addzero.util.lsi.types.NullabilityAnnotationType")
)
const val NULL_MARKED_ANNOTATION_SIMPLE_NAME = "NullMarked"

@Deprecated(
    "Use NullabilityAnnotationType.NULL_UNMARKED.simpleName instead",
    ReplaceWith("NullabilityAnnotationType.NULL_UNMARKED.simpleName", "site.addzero.util.lsi.types.NullabilityAnnotationType")
)
