...
import site.addzero.util.lsi.types.TypeRegistry
...
@Deprecated(
    ...
    replaceWith = ReplaceWith("TypeChecker.isNumericType(typeName)", "site.addzero.util.lsi.assist.TypeChecker")
)
...
@Deprecated(
    ...
    replaceWith = ReplaceWith("TypeChecker.isBooleanType(typeName)", "site.addzero.util.lsi.assist.TypeChecker")
)
...
@Deprecated(
    ...
    replaceWith = ReplaceWith("TypeChecker.isStringType(typeName)", "site.addzero.util.lsi.assist.TypeChecker")
)
...
@Deprecated(
    ...
    replaceWith = ReplaceWith("TypeChecker.isDateTimeType(typeName)", "site.addzero.util.lsi.assist.TypeChecker")
)
